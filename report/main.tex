...
\textbf{Global} & \begin{tabular}[c]{@{}p{3cm}@{}}temporal distance\\ \{0: 34728, 1: 3\}\end{tabular} \\ \hline
\textbf{Node} & \begin{tabular}[c]{@{}p{3cm}@{}}temporal distance\\ \{0: 2, 2: 1\}\end{tabular} \\ \hline
\textbf{Edge} & \begin{tabular}[c]{@{}p{3cm}@{}}temporal distance \\ \{3: 1\}\end{tabular} \\ \hline
\end{tabular}
\end{table}
